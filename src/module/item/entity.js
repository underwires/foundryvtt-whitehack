 ...
 */
export class WhitehackItem extends Item {
  /* -------------------------------------------- */
  /*	Data Preparation														*/
  /* -------------------------------------------- */
  /**
  ...
  prepareData() {
    ...
    switch (this.data.type) {
      case "spell":
        img = "/systems/whitehack/assets/default/spell.png";
        break;
      case "ability":
        img = "/systems/whitehack/assets/default/ability.png";
        break;
      case "armor":
        img = "/systems/whitehack/assets/default/armor.png";
        break;
      case "weapon":
        img = "/systems/whitehack/assets/default/weapon.png";
        break;
      case "item":
        img = "/systems/whitehack/assets/default/item.png";
        break;
    }
  ...
  async rollFormula(options = {}) {
    ...
    return WhitehackDice.Roll({
      ...
      flavor: game.i18n.format("WH.roll.formula", { label: label }),
      title: game.i18n.format("WH.roll.formula", { label: label }),
    });
  }
  ...
  getTags() {
    ...
    switch (this.data.type) {
      case "weapon":
        ...
        wTags += formatTag(CONFIG.WH.saves_long[data.save], "fa-skull");
        if (data.missile) {
          wTags += formatTag(
        ...
        return wTags;
      case "armor":
        return `${formatTag(CONFIG.WH.armor[data.type], "fa-tshirt")}`;
      case "item":
        return "";
      case "spell":
        ...
        if (data.save) {
          sTags += formatTag(CONFIG.WH.saves_long[data.save], "fa-skull");
        }
        return sTags;
      case "ability":
        let roll = "";
        roll += data.roll ? data.roll : "";
        roll += data.rollTarget ? CONFIG.WH.roll_type[data.rollType] : "";
  ...
  pushTag(values) {
    ...
    if (update) {
      values.forEach((val) => {
        ...
        switch (val) {
          case CONFIG.WH.tags.melee:
            newData.melee = true;
            break;
          case CONFIG.WH.tags.slow:
            newData.slow = true;
            break;
          case CONFIG.WH.tags.missile:
  ...
  async show() {
    ...
    const template = `systems/whitehack/templates/chat/item-card.html`;
