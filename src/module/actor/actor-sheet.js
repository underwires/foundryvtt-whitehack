...
import { WhitehackEntityTweaks } from "../dialog/entity-tweaks.js";

export class WhitehackActorSheet extends ActorSheet {
  constructor(...args) {
    super(...args);
  }
  /* -------------------------------------------- */
  ...
  getData() {
    ...
    data.config.encumbranceBasic =
      game.settings.get("whitehack", "encumbranceOption") == "basic";
  ...
  _onConfigureActor(event) {
    event.preventDefault();
    new WhitehackEntityTweaks(this.actor, {
  ...
  _getHeaderButtons() {
    ...
    if (this.options.editable && canConfigure) {
      buttons = [
        {
          label: game.i18n.localize("WH.dialog.tweaks"),
