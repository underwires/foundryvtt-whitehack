 ...
 */
export class WhitehackActorSheetMonster extends WhitehackActorSheet {
  constructor(...args) {
    super(...args);
  }
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["whitehack", "sheet", "monster", "actor"],
      template: "systems/whitehack/templates/actors/monster-sheet.html",
      width: 450,
      height: 560,
      resizable: true,
      tabs: [
   ...
   */
  async generateSave() {
    let choices = CONFIG.WH.monster_saves;

    let templateData = { choices: choices },
      dlg = await renderTemplate(
        "/systems/whitehack/templates/actors/dialogs/monster-saves.html",
        templateData
      );
    //Create Dialog window
    new Dialog({
      title: game.i18n.localize("WH.dialog.generateSaves"),
      content: dlg,
      buttons: {
        ok: {
  ...
  getData() {
    ...
    // Settings
    data.config.morale = game.settings.get("whitehack", "morale");
